...
static_list = ['.git', '.github', '.gitignore', 'LICENSE', 'README.md', 'files_trainable', 'imgs', 'imgs2', 'masks', 'masks2', 'pencil', 'requirements.txt', 'sample.gif', 'sample.jpg', 'scale', 'runstat.py', 'tools', 'viewer.py', 'make_sa_dataset.sh', 'move_sa.py']
