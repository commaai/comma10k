...
2. Start labelling! Useful label tools:
   * [img-labeler](https://erikbernheim.github.io/img-labeler/) (Only compatible chrome, and should be used with browser zoom and monitor scaling disabled. Other chromium based browsers don't work)
