...
2. Start labelling! Useful label tools:
   * [img-labeler](https://erikbernheim.github.io/img-labeler/) (Only compatible Chrome and Edge. Other browsers like brave even if chromium based don't work correctly. Must be used with browser zoom and monitor scaling disabled.)
